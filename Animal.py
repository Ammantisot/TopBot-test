...
def scissors(message):
    r = choice(["камень", "ножницы", "бумага"])
    if r == "камень":
        bot.send_message(message.chat.id, f"Вы проиграли), бот выбрал {r}")
    elif r == "ножницы":
        bot.send_message(message.chat.id, f"Ничья, бот выбрал {r}")
    elif r == "бумага":
        bot.send_message(message.chat.id, f"Вы выиграли), бот выбрал {r}")
...
def paper(message):
    ...
    if r == "ножницы":
        ...
        bot.send_message(message.chat.id, f"Вы выиграли), блт выбрал {r}")
